export default function About() {
  return (
    <div className="page">
      <h1 style={{ fontSize: '1.4rem', fontWeight: 800, marginBottom: 20 }}>CoupledMD &mdash; 222 GPCR&ndash;G-protein MD simulations</h1>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <p style={{ color: 'var(--muted)', fontSize: 14, lineHeight: 1.7, maxWidth: 720 }}>
          ...
          for active-state GPCR&ndash;G-protein ternary complexes. It covers <strong>222 systems</strong> across
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <div className="stat-grid" style={{ maxWidth: 720 }}>
          ...
          <div className="stat-card">
            ...
            <div className="label">Unique receptors</div>
          </div>
          <div className="stat-card">
            <div className="num">~332 &mu;s</div>
      ...
      <section style={{ marginBottom: 32 }}>
        ...
        <div className="detail-card" style={{ maxWidth: 720 }}>
          <div className="kv"><span className="k">Systems</span><span className="v">222 active-state ternary complexes</span></div>
          ...
          <div className="kv"><span className="k">Starting structures</span><span className="v">Experimental cryo-EM / X-ray ternary complexes (211); 11 engineered/uncertain</span></div>
          <div className="kv"><span className="k">Membrane</span><span className="v">222 membrane-embedded (POPC/POPE mixtures)</span></div>
          ...
          <div className="kv"><span className="k">Total sampling</span><span className="v">&gt;330 &mu;s aggregate</span></div>
        </div>
      </section>
        ...
        <div style={{ maxWidth: 720 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <PipelineStep
              ...
              desc="Canonical inventory of 222 systems with force-field corrections, file integrity checks, and structural provenance classification (experimental vs. engineered/uncertain)."
            />
            <PipelineStep
              n="2"
