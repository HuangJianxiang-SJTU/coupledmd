...
const SECTIONS = [
  {
    ...
    content: (
      <>
        ...
        <strong> 207 validated active-state GPCR&ndash;G-protein ternary complexes</strong> across
    ...
    content: (
      <>
        ...
        <table style={{ fontSize: 12, marginTop: 8, marginBottom: 12 }}>
          ...
          <tbody>
            <tr><td style={{ padding: '4px 12px', fontFamily: 'monospace' }}>GET /api/v1/systems</td><td style={{ padding: '4px 12px' }}>All 207 validated systems</td></tr>
