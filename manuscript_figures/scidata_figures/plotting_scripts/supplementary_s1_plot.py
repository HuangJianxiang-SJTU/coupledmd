#!/usr/bin/env python3
"""Supplementary Figure S1: final-207 receptor family-profile dendrogram."""
import numpy as np
import matplotlib.pyplot as plt
from matplotlib.lines import Line2D
from scipy.cluster.hierarchy import linkage, leaves_list, to_tree
try:
 from .final208_figures import OUT, F, FL, C, INK, MUTED, load
except ImportError:
 from final208_figures import OUT, F, FL, C, INK, MUTED, load
...
plt.close(fig)
print('S1 assertions passed: 207 systems; 174 receptor names; 173 mapped UniProt accessions; Gs_8HTI unmapped')
